...
// Used for log scanning only (not for adapter start)
...
// Factory deployment timestamp (2026-08-15T18:24:52Z)
// Used as adapter start time
// Source: https://bscscan.com/tx/0x83c59454a1ab8d8e522d6a6af749cbe0cf63208239f1e51622370ebcfea5d7be
const FACTORY_DEPLOYMENT_TIMESTAMP = '2026-08-15';

// Interval in blocks for re-scanning CurveCreated events
// BSC produces ~1 block every 3 seconds, so 100 blocks ≈ 5 minutes
// This reduces RPC calls to avoid rate limits on public endpoints
// Source: https://docs.bnbchain.org/docs/overview
const CURVE_DISCOVERY_BLOCK_INTERVAL = 100;
...
const fetch = async (options: FetchOptions) => {
  ...
  // Only re-scan every CURVE_DISCOVERY_BLOCK_INTERVAL blocks to avoid rate limits
  if (cachedCurves.size === 0 || currentBlock > lastScannedBlock + CURVE_DISCOVERY_BLOCK_INTERVAL) {
...
const adapter: Adapter = {
  ...
  pullHourly: true,
  chains: [CHAIN.BSC],
  // Unix timestamp of factory deployment as string
  // Source: https://bscscan.com/tx/0x83c59454a1ab8d8e522d6a6af749cbe0cf63208239f1e51622370ebcfea5d7be
  start: FACTORY_DEPLOYMENT_TIMESTAMP,
  fetch,
  methodology,
